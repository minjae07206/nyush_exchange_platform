    ...
    return (
        <div className={className}>
            {isSearchBarPopUpVisible && (
                ...
                <div className="fixed top-14 inset-0 bg-gray-500 opacity-50 z-10" onClick={hideSearchBarPopUp}></div>
            ...
            <button className="hidden sm:block" onClick={showSearchBarPopUp}>
