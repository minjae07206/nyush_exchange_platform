...
export default function FilterBar() {
    ...
    const categoryOptions = ['All categories', 'Textbook', 'Kitchenware', 'Food' ,'Others'];
    ...
    const buySellOptions = ['All post types', 'Sell posts', 'Buy posts'];
    ...
    const setBuySellOption = useFilterStore((state)=>state.setBuySellOption);
    ...
    return (
        <div className="flex justify-start mt-1 mb-1 min-w-[280px]">
            ...
            <DropDownMenu name="buySellOption" className={DropDownMenuClass} options={buySellOptions} value={buySellOption} handleSelectChange={(e: React.ChangeEvent<HTMLSelectElement>)=>{setBuySellOption(e.target.value);}}></DropDownMenu>
